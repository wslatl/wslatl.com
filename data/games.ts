...
export interface GameEntry {
  ...
  popularFor: string[]
  faqs: GameFaq[]
  /** Shown in the featured row on /games. These are the titles our own copy names. */
  featured?: boolean
}
...
export const games: GameEntry[] = [
  ...
  { slug: 'beammp', name: 'BeamMP (BeamNG.drive)', category: 'Roleplay & Platforms', tagline: 'Multiplayer BeamNG.drive sessions.', description: 'BeamMP brings persistent multiplayer to BeamNG.drive\'s soft-body vehicle simulation. Lightweight on the server side since physics run client-side.', recommendedRam: [{ players: '4-16 players', ram: '2-4GB' }], popularFor: ['community driving and crash servers'], faqs: [] },
...
/**
 * RAM a scenario needs, in GB: the top of its range ("2-4GB" -> 4,
