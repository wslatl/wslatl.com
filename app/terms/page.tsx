    ...
    >
      ...
      <LegalSection number="3" title="Application & Account Registration">
        ...
        <ul className="list-disc pl-5 space-y-2 mt-2">
          ...
          <li>You must notify us immediately at support@wslatl.com if you suspect unauthorized access to your account</li>
      ...
      <LegalSection number="5" title="Service Level Agreement (SLA)">
        ...
        <LegalSubSection title="5.3 SLA Credits">
          ...
          <p className="mt-2">
            To request a credit, contact us within 15 days of the incident at support@wslatl.com with
      ...
      <LegalSection number="6" title="Acceptable Use">
        <p>
          ...
          <a href="/acceptable-use" className="text-primary hover:underline">wslatl.com/acceptable-use</a>.
      ...
      <LegalSection number="8" title="DMCA & Copyright">
        ...
        <div className="mt-3 p-4 rounded-xl border border-border/70 bg-card/30 text-sm space-y-1 relative overflow-hidden">
          ...
          <p><span className="text-foreground font-medium">Email:</span> support@wslatl.com</p>
      ...
      <LegalSection number="13" title="Governing Law & Dispute Resolution">
        ...
        <p>
          ...
          disputes informally. To initiate informal resolution, contact us at support@wslatl.com
      ...
      <LegalSection number="14" title="Modification of Terms">
        ...
        <ul className="list-disc pl-5 space-y-1.5 mt-2">
          ...
          <li>Post the updated Terms at wslatl.com/terms with a revised effective date</li>
